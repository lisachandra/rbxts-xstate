...
describe("event emitter", () => {
	...
	it("events can be emitted from promise logic", () => {
		...
		const logic = fromPromise<any, any, { type: "emitted"; msg: string }>(async ({ emit }) => {
			emit({
				type: "emitted",
				msg: "hello",
			});
	...
	it("events can be emitted from observable logic", () => {
		...
		const logic = fromObservable<any, any, { type: "emitted"; msg: string }>(({ emit }) => {
			emit({
				type: "emitted",
				msg: "hello",
			});
	...
	it("events can be emitted from event observable logic", () => {
		...
		const logic = fromEventObservable<any, any, { type: "emitted"; msg: string }>(
			({ emit }) => {
				emit({
					type: "emitted",
					msg: "hello",
	...
	it("events can be emitted from callback logic", () => {
		...
		const logic = fromCallback<any, any, { type: "emitted"; msg: string }>(({ emit }) => {
			emit({
				type: "emitted",
				msg: "hello",
			});
