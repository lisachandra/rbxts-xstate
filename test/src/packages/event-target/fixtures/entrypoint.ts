...
async function main(): Promise<number> {
	...
	tester.suite.emit("require", await import("../event-target"), "event-target.ts", tester);
	...
	tester.suite.emit("require", await import("../event-attribute"), "event-attribute.ts", tester);
	tester.suite.emit("post-require", Global, "event-attribute.ts", tester);

	tester.suite.emit("pre-require", Global, "define-custom-event-target.ts", tester);
	tester.suite.emit(
		"require",
	...
	tester.suite.emit("post-require", Global, "define-custom-event-target.ts", tester);
	...
	tester.suite.emit("post-require", Global, "default-error-handler.ts", tester);

	tester.suite.emit("pre-require", Global, "default-warning-handler.ts", tester);
	tester.suite.emit(
		"require",
	...
	tester.suite.emit("post-require", Global, "default-warning-handler.ts", tester);
