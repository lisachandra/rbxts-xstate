...
export interface ByRoleOptions {
	...
	hidden?: boolean;
	/**
	 * If true only includes elements in the query set that are marked as selected
	 * in the accessibility tree, i.e., `aria-selected="true"`
	 */
	selected?: boolean;
	/**
	 * If true only includes elements in the query set that are marked as busy in
	 * the accessibility tree, i.e., `aria-busy="true"`
	 */
	busy?: boolean;
	/**
	 * If true only includes elements in the query set that are marked as checked
	 * in the accessibility tree, i.e., `aria-checked="true"`
	 */
	checked?: boolean;
	/**
	 * If true only includes elements in the query set that are marked as pressed
	 * in the accessibility tree, i.e., `aria-pressed="true"`
	 */
	pressed?: boolean;
	/**
	...
	/**
	 * If true only includes elements in the query set that are marked as expanded
	 * in the accessibility tree, i.e., `aria-expanded="true"`
	 */
	expanded?: boolean;
	/**
	 ...
	 * *ByRole('progressbar', {queryFallbacks: true})` will find <div role="meter
	 * progressbar">`.
	 */
